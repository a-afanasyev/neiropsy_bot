...
- `user_states` - сохраненное состояние пользователей в боте

См. подробности в `app/migrations/001_init.sql` и `app/migrations/002_user_states.sql`.
...
- [x] Персистентное хранение состояний пользователей (PostgreSQL)
